    ...
    return (_jsxs("div", { className: "graph-view-panel", children: [_jsxs("article", { className: "dashboard-main-card", children: [_jsxs("div", { className: "panel-heading", children: [_jsxs("div", { children: [_jsx("p", { className: "eyebrow", children: "PRICE ACTION" }), _jsxs("h2", { style: { display: 'flex', alignItems: 'baseline', gap: '10px' }, children: [symbol, " Historical Chart", historicalTrend && (_jsxs("span", { style: {
                                            ...
                                            color: technicals?.rsi_14 != null
                                                ...
                                                : technicals?.rsi_status === 'Oversold'
                                                    ? 'badge-bullish'
                                                    : 'badge-neutral'}`, children: technicals?.rsi_status || 'Neutral' }) })] }), _jsxs("div", { className: "technical-card", children: [_jsx("span", { className: "card-label", children: "MACD (12, 26, 9)" }), _jsx("div", { className: "card-value", style: {
                                            color: technicals?.macd?.histogram != null
                                                ? technicals.macd.histogram > 0
                                                    ? '#22c55e'
                                                    : '#ef4444'
                                                : '#f8fafc',
                                        }, children: technicals?.macd?.histogram != null ? (_jsxs("span", { children: [technicals.macd.histogram > 0 ? '+' : '', technicals.macd.histogram.toFixed(2)] })) : (NA) }), _jsx("div", { className: "card-subtext", children: _jsx("span", { className: `badge-pill ${technicals?.macd?.status?.includes('Bullish') ? 'badge-bullish' : 'badge-neutral'}`, children: technicals?.macd?.status || 'Neutral' }) })] }), _jsxs("div", { className: "technical-card", children: [_jsx("span", { className: "card-label", children: "Moving Averages" }), _jsxs("div", { className: "card-value", style: {
                                            fontSize: '14px',
                                            color: sma50 != null ? (price >= sma50 ? '#22c55e' : '#ef4444') : '#f8fafc',
                                        }, children: ["SMA50: ", sma50 != null ? currencyFormatter.format(sma50) : NA] }), _jsxs("div", { className: "card-subtext", style: {
                                            color: sma200 != null ? (price >= sma200 ? '#22c55e' : '#ef4444') : '#9ca3af',
                                        }, children: ["SMA200: ", sma200 != null ? currencyFormatter.format(sma200) : NA] })] }), _jsxs("div", { className: "technical-card", children: [_jsx("span", { className: "card-label", children: "52-Week Range" }), _jsx("div", { className: "range-meter-track", style: { background: 'linear-gradient(to right, #ef4444, #eab308, #22c55e)', position: 'relative', height: '6px', borderRadius: '99px', margin: '8px 0 4px' }, children: _jsx("div", { style: {
                                                position: 'absolute',
                                                top: '-4px',
                                                left: `${rangePct}%`,
                                                width: '14px',
